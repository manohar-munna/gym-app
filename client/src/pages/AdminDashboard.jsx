              ...
              <div className="flex flex-col md:flex-row gap-3 justify-between items-center">
                ...
                <div className="flex gap-2 w-full md:w-auto items-center">
                    <input type="number" placeholder="Days..." value={customDays} onChange={(e) => { setCustomDays(e.target.value); setFilter('custom'); }} 
                        className="bg-black border border-gray-700 text-white px-3 py-2 rounded text-xs w-20 focus:border-gymGold outline-none h-10" />
          ...
          <div className="fixed inset-0 bg-black/80 z-50 flex items-center justify-center p-4 backdrop-blur-sm">
              <motion.div initial={{scale:0.9, opacity:0}} animate={{scale:1, opacity:1}} className="bg-[#1c1c1c] p-6 md:p-8 rounded-lg w-full max-w-md border border-gymGold shadow-2xl relative">
                  ...
                  <div className="space-y-4">
                      ...
                      <div><label className="text-xs font-bold text-gray-500 mb-1 block">WhatsApp</label><input type="number" value={formData.phone} onChange={(e) => setFormData({...formData, phone: e.target.value})} className="w-full bg-black border border-gray-700 text-white p-3 rounded focus:border-gymGold outline-none" /></div>
